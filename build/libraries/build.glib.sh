...
cd __build
export CFLAGS="$FLAGS"
meson --prefix=/usr/local --cross-file ../../../../../meson-cross.txt --default-library=static -Dselinux=disabled -Dxattr=false -Dlibmount=disabled -Dnls=disabled -Dinternal_pcre=true -Dgtk_doc=false -Dman=false ..
ninja install
